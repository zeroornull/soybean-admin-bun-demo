...
function signalChild(child: ChildProcess | undefined, signal: NodeJS.Signals) {
  ...
  try {
    ...
    if ((error as NodeJS.ErrnoException).code !== 'ESRCH') {
      console.error(`[dev] failed to send ${signal} to child ${child.pid}:`, error);
    }
  }
}
