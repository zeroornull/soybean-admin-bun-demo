...
- R02 初验时，9528–9553 位于 Windows excluded range，9554 又有另一个 `bun dev`，因此临时使用 9555；D14/D15 后已在高位起始端口重新验证根 HTML、main、loading、assets、reset、App 和 favicon 全部 HTTP 200；
